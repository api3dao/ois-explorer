...
import { useDarkModeManager } from './LocalStorage'
...
export const theme = (darkMode, color) => ({
  customColor: color,
  textColor: darkMode ? color : 'black',

  panelColor: darkMode ? 'rgba(255, 255, 255, 0)' : 'rgba(255, 255, 255, 0)',
  backgroundColor: darkMode ? '#655A49' : '#F7F8FA',
  ...
  // backgrounds / greys
  bg1: darkMode ? '#42454D' : '#FAFAFA',
  bg2: darkMode ? '#2C2F36' : '#F7F8FA',
  bg3: darkMode ? 'rgba(106, 90, 86,0.7)' : '#EDEEF2',
  bg4: darkMode ? '#565A69' : '#CED0D9',
  bg5: darkMode ? '#565A69' : '#888D9B',
  bg6: darkMode ? '#000' : '#FFFFFF',
  bg7: darkMode ? '#79797b' : '#FFF',

  //specialty colors
  modalBG: darkMode ? 'rgba(0,0,0,0.85)' : 'rgba(0,0,0,0.6)',
  //advancedBG: darkMode ? 'rgba(101, 90, 73, 20)' : 'rgba(255,255,255,0.4)',
  //advancedBG: darkMode ? 'rgba(98, 92, 85, 0.5)' : 'rgba(255,255,255,0.4)',
  advancedBG: darkMode ? 'rgba(31, 32, 33, 0.3)' : 'rgba(255,255,255,0.4)',
...
export const ThemedBackground = styled.div`
  ...
  ${'' /* background: ${({ backgroundColor }) =>
    `linear-gradient(180deg, rgba(146,107,82,1) 13%, rgba(0,0,0,1) 69%)`}; */}
  position: absolute;
  top: 0px;
  left: 0px;
  /* z-index: ; */
